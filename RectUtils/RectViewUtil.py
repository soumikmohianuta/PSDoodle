...
# Rect view util for screenshot processor
...
VIEW_TYPE_LIST = 4
VIEW_TYPE_ICON = 5
VIEW_TYPE_CHECK_BOX = 6
VIEW_TYPE_RADIO_BUTTON = 7
VIEW_TYPE_IMAGE_USER = 8
VIEW_TYPE_SWITCH = 9
VIEW_TYPE_SEEK = 10
VIEW_TYPE_VIR_SEEK = 11
VIEW_TYPE_RATING = 12
VIEW_TYPE_SEARCH = 13
VIEW_TYPE_CONTAINER= 14
...
#
    ...
    def getItemType(self,rectView):
        ...
        if(rectView.getType()== VIEW_TYPE_IMAGE):
            itemType.type = FileMetadata.IMAGE
            
        if(rectView.getType()== VIEW_TYPE_TEXT):
