...
from RectUtils import RectViewUtil
# from ocr.TextInfo import TextInfo


# Create RectView for Screenshot Processor
class RectView:
    ...
    def __init__(self,rect=Rect(),contour=None):
        ...
        self.mImageInfo = RectViewUtil.ImageInfo()
        self.mListInfo = RectViewUtil.ListInfo();
        self.mTextInfo = TextInfo()
        self.mType = RectViewUtil.VIEW_TYPE_DEFAULT
        self.x = rect.x
        self.y = rect.y
        ...
        self.mImageInfo = RectViewUtil.ImageInfo()
        self.mListItemInfo = RectViewUtil.ListItemInfo()
        self.textColor =  0
